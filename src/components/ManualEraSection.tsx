...
const ManualEraSection = () => {
  ...
  return (
    <section id="logic" className="py-16 md:py-32 px-4 md:px-12 bg-[#050505] relative z-10">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-20 items-center">
        ...
        >
          <h2 className="font-heading text-3xl sm:text-4xl md:text-6xl font-black mb-6 md:mb-8 leading-tight">
            The Manual Era <br />
          ...
          <div className="space-y-4 md:space-y-6">
            <div className="flex items-start space-x-3 md:space-x-4 group">
              <div className="w-6 h-6 shrink-0 rounded-full border border-primary flex items-center justify-center text-[10px] text-primary group-hover:bg-primary group-hover:text-black transition-all">
                01
              </div>
              <p className="text-foreground/80 text-xs md:text-sm font-bold uppercase tracking-widest">
        ...
        <div
          ref={rightRef}
          className={`glass rounded-2xl md:rounded-3xl p-2 aspect-[4/3] md:aspect-video relative overflow-hidden group transition-all duration-1000 ${
        ...
        >
          ...
          <div className="p-4 md:p-8 h-full flex flex-col">
            <div className="flex justify-between items-center mb-6 md:mb-12">
              ...
              <span className="text-[7px] md:text-[9px] font-black uppercase tracking-widest text-muted-foreground">
                Active Pipeline: 598 Nodes
              </span>
            </div>
            <div className="flex-grow flex items-end space-x-2 md:space-x-3">
